...
class RegisterViewModel: ObservableObject {
    ...
    @Published var authenticator: String = "d"
    @Published var email: String = "d@dc.c"
    @Published var password: String = "d"
    @Published var firstName: String = "d"
    @Published var lastName: String = "d"
